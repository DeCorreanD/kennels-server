...
# def get_all_animals():
#     return ANIMALS
# This was the Way done before SQL Database was added
...
# This Was The Way We Wrote This Function Before SQL Database
...
def get_animal_location(location_id):
